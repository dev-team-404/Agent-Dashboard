...
export const statsApi = {
  ...
  modelUserTrend: (modelId: string, days = 30, topN = 10, serviceId?: string, aliasName?: string) =>
    api.get('/admin/stats/model-user-trend', { params: { modelId: aliasName ? undefined : modelId, aliasName, days, topN, serviceId } }),
